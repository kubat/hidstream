...
var hidPacket = function hidPacket() {
    ...
    return {
        ...
        shift:   function() { return modifiers.l_shift   || modifiers.r_shift; },
        control: function() { return modifiers.l_control || modifiers.r_control; },
        alt:     function() { return modifiers.l_alt     || modifiers.r_alt; },
        meta:    function() { return modifiers.l_meta    || modifiers.r_meta; },

        mod:     function() { return modifiers.l_shift   || modifiers.r_shift   ||
                                     modifiers.l_control || modifiers.r_control ||
                                     modifiers.l_alt     || modifiers.r_alt     ||
                                     modifiers.l_meta    || modifiers.r_meta; },
        empty:   function() { return ! this.mod() && this.keyCodes.length === 0; }
...
*/
var parseModifiers = function parseModifiers(packet, bits) {
...
var parseCharCodes = function parseCharCodes(packet, keys) {
    if (typeof keys !== "object") { return false; }

    var shift = packet.shift();

    var push  = function(a, A) { packet.charCodes.push(shift ? A : a); };
...
*/
var parseErrorState = function(packet, state) {
    var states = 0;

    state.forEach(function(s) { if(s === 1) { ++states; } });
